...
BandpassFilter::BandpassFilter(int low_window_size, int high_window_size)
    : low_window_size_(low_window_size)
    , high_window_size_(high_window_size) {
    validate_odd_window(low_window_size_, "bandpass low_window");
    validate_odd_window(high_window_size_, "bandpass high_window");
}
...
int BandpassFilter::get_low_window_size() const {
    return low_window_size_;
}

int BandpassFilter::get_high_window_size() const {
