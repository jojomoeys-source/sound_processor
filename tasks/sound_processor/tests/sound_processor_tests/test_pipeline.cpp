...
// Проверяет: CmdLineArgs2PipelineConverter создаёт Pipeline из FilterDescriptor
...
// Проверяет: CmdLineArgs2PipelineConverter для unknown filter вызывает exception
...
// Проверяет: CmdLineArgs2PipelineConverter отклоняет null producer
...
// Проверяет: Application с generator игнорирует отсутствующий input file
